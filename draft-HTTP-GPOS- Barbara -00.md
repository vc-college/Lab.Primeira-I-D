**Working Group Name**  **Bárbara Santana**
...
Conhecendo que o protocolo HTTP faz uso do serviço cliente-servidor, foi pensado
fazer uma extenção do protocolo HTTP para que ele consiga fazer uma requisição 
de localização geográfica de um site.
...
Baseado nas mensagens do cliente e servidor do protocolo HTTP e a RFC 1712,
a expanção desse protocoloco ficaria com as mensagens na seguinte estrutura:

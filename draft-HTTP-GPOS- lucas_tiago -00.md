**Working Group Name**  **Lucas. Pereira**
...
## 1. Introduction
O HTTP-GPOS, protocolo implementado sobre HTTP, dedica-se a implementar uma forma de requisitar a localização geográfica do servidor através do GPOS (RFC 1712).
...
A mensagem de requisição GET, definido no protocolo HTTP, deve incluir um campo que segue o formato: "GPOS: nome_dispositivo". Não obstante, o formato da resposta deve ser "nome_dispositivo ttl class GPOS longitude latitude altitude".
